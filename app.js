  ...
  function menuHtml(){
    return `
      ...
      <div class="sideMenu" id="sideMenu" style="display:none" data-open="0" role="dialog" aria-modal="true">
        ...
        <a href="#" class="sideItem" onclick="closeMenu(); navTo({name:'home',spiritId:null,prevTab:'home'}); return false;">🏠 Explorer</a>
        <a href="#" class="sideItem" onclick="closeMenu(); navTo({name:'cellar',spiritId:null,prevTab:'cellar'}); return false;">🍾 Ma cave</a>

        <div class="sideDivider"></div>

        <a href="#" class="sideItem" onclick="closeMenu(); alert('Paramètres (démo)'); return false;">⚙️ Paramètres</a>
        <a href="#" class="sideItem" onclick="closeMenu(); alert('Aide (démo)'); return false;">❓ Aide</a>
    ...
    return `
      <div class="topbar topbarBack">
        <div class="topbarInner">
          ...
          <div class="brand brandCenter">
            <img class="brandLogoSmall" src="./assets/logo-diamond-256-v34.png" alt="Liquorne"/>
            <div class="brandText">${esc(title || "Liquorne")}</div>
          </div>
